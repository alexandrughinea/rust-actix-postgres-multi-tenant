...
# Check if a custom database name has been set, otherwise default to "rust_actix_postgres_multi_tenant".
DB_NAME="${POSTGRES_DB:=rust_actix_postgres_multi_tenant}"
