...
DO $$
    ...
    BEGIN
        ...
        PERFORM setup_tenant_base_role_and_access(tenant_base_role);

        -- Add two tenants example (skippable in a production setup):
        ...
        -- Apply multi-tenant setup policies:
        FOREACH current_table IN ARRAY security_policy_impacted_tables
            LOOP
                ...
                PERFORM add_table_tenant_row_level_isolation_policy(current_table, tenant_base_role);
            END LOOP;
    EXCEPTION
        WHEN OTHERS THEN
